...
echo "This script will convert only your partrepair, parts and binaries table to InnoDB with compressed row format..\n";
echo "This may take a while depending on how large your tables are. Do not stop this script. It will finish.\n\n";

echo "Converting the partrepair table to InnoDB with compressed row format.\n";
$db->query("ALTER TABLE partrepair ENGINE=InnoDB ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;");
echo "Finished converting the partrepair table to InnoDB with compressed row format..\n\n";
